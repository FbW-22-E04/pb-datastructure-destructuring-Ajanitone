...
console.log("Q1:My array is:", fruit, vegetable, food);
...
const { fran, kirk } = halloween;

console.log("Q2:", fran, kirk);
...
const bandMusician = {
  ...
  GreatestHit: "I love marijuana",
  nationality: "Jamaican",
  genre: "Reggae",
};

function bandData({ name, GreatestHit, nationality, genre }) {
  return `Q3: ${name} is a ${nationality} singer. The musician sings ${genre} and his greatest hit is ${GreatestHit} `;
}
